...
> **공식 사업명** — `솔루션 기반 PG 시스템 신규 구축 사업` · `2026.01.01 ~ 2026.02.28` · KOSA 인증
>
...
| 💰 일 거래액 | 📜 KOSA 인증 | 🧑‍💻 경력 | 🤖 AI 워크플로우 |
|:---:|:---:|:---:|:---:|
| **₩20억+** | **19+ Projects** | **7년차** | **자체 OMC** |
| 티켓나라 결제 | 정부 SW기술자 검증 | Backend · Infra · AI | 멀티 에이전트 운영 |
...
> 🛡 **신뢰성 부스터** — "AI 만능" 톤만이 아니라, **공공·SI·결제·SaaS 전 영역의 정통 SW기술자 경력** 이 정부 인증으로 검증됨.
